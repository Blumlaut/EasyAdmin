...
AddEventHandler('EasyAdmin:CaptureScreenshot', function(toggle, url, field)
	exports['screenshot-basic']:requestScreenshotUpload(GetConvar("ea_screenshoturl", 'https://pomf.tdude.co/upload.php'), GetConvar("ea_screenshotfield", 'files[]'), json.decode(GetConvar("ea_screenshotOptions", "{}")) , function(data)
			local resp = json.decode(data)
			TriggerServerEvent("EasyAdmin:TookScreenshot", resp)
	end)
end)
