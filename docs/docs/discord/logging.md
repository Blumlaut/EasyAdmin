...
When bot logging is not configured (`ea_botLogChannel` is empty), EasyAdmin falls back to webhook notifications as described in the [Webhooks](../configuration/webhooks.md) guide.
