// bot/commands/mute.js
module.exports = {
  data: new SlashCommandBuilder().setName("mute").setDescription("Mutes a User").addStringOption((option) => option.setName("user").setDescription("Username or ID").setRequired(true)),
  async execute(interaction, exports2) {
    ...
    var ret = await exports2[EasyAdmin].mutePlayer(user.id, true);
    if (ret) {
