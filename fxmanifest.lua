...
server_scripts {
    ...
    "server/storage.lua",
    "server/stats/*.lua",
    "server/metrics/os_detect.lua",
    "server/metrics/cpu.lua",
    "server/metrics/memory.lua",
    "server/metrics/disk.lua",
    "server/metrics/network.lua",
    "server/metrics/processes.lua",
    "server/metrics/metrics_events.lua",
    "server/features/*.lua",
    "server/*.lua",
    "dist/*.js",
    "plugins/**/*_shared.lua",
