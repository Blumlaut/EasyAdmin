...
convar_category 'EasyAdmin' {
    "Configuration Options",
    {
        ...
        { "Stream STUN Servers (comma-separated)", "$ea_streamStunServers", "CV_STRING", "stun:stun.l.google.com:19302" },
        { "Stream TURN Servers (comma-separated)", "$ea_streamTurnServers", "CV_STRING", "" },
        { "Stream TURN Username", "$ea_streamTurnUser", "CV_STRING", "" },
        { "Stream TURN Password", "$ea_streamTurnPassword", "CV_STRING", "" },
