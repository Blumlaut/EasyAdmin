// bot/commands/freeze.js
module.exports = {
  data: new SlashCommandBuilder().setName("freeze").setDescription("Freezes player").addStringOption((option) => option.setName("user").setDescription("Username or ID").setRequired(true)),
  async execute(interaction, exports2) {
    ...
    var ret = await exports2[EasyAdmin].freezePlayer(user.id, true);
    if (ret) {
